describe("BoiteDeBonbons", function() {
	...
	beforeEach();
    it("Lorsque quelqu'un retire 20 bonbons d'une boîte plastique de 510 bonbons (d'un seul type de bonbon), il devrait y avoir 490 bonbons qui restent dans la boîte.", function() {
	...
	for (var i = 1; i <= 20; i++) {
		...
		it("TEST ALÉATOIRE #" + i + ": Lorsque quelqu'un " + motAction + " " + combien + " bonbons d'une boîte plastique de " + (bType1tout + bType2tout) + " bonbons (de type " + quelTypeNom + "), il devrait y avoir " + awaitedResult + " bonbons qui restent dans la boîte.", function() {
